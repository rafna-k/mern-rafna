indiaDetails = [
  ...
  // console.log(indiaDetails[0].name.common)
  // console.log(indiaDetails[0].capital)
  // console.log(indiaDetails[0].population)
  // console.log(indiaDetails[1].borders)
  // console.log(indiaDetails[0].currencies)
  // console.log(indiaDetails[1].languages)
  // console.log(indiaDetails[0].continents)
  console.log(indiaDetails[1].maps.googleMaps)
